...
public class Exemplo8_5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleciona o sexo");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(masc, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(verif)
    ...
    private void verifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verifActionPerformed
        if (masc.isSelected() && fem.isSelected()) {
            JOptionPane.showMessageDialog(null, "Seleciona apenas um sexo");
        }
        if (fem.isSelected()) {
            if (!masc.isSelected()) {
        ...
        if (masc.isSelected()){ 
            ...
            JOptionPane.showMessageDialog(null, "Selciona um sexo");
        }
